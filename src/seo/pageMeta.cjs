...
const PAGES = [
  ...
  },
  {
    ...
    description:
      '山海灵境内容指南：八字排盘教程、节气换月对照、日主怎么看、测字例子与选字避坑、易经提问模板。用可执行步骤学会东方符号工具。',
    keywords: '八字教程, 节气换月, 八字日主, 测字例子, 测字避坑, 易经提问模板, 玄学指南, 山海灵境指南',
  ...
  {
    file: 'guides/bazi-month-pillar-solar-terms.html',
    title: '为什么同一天出生月柱会不同 | 节气换月对照 | 山海灵境',
    description:
      '八字月柱按节气时刻换，不按日历日。用 2024 立春 16:27 的可复现对照：16:26 仍是癸卯乙丑，16:28 已是甲辰丙寅。说明 AI 排盘为什么会排错月柱。',
    keywords:
      '八字月柱, 节气换月, 立春换年柱, 月柱不准, AI排盘错误, 真太阳时, 八字排盘对照, 山海灵境',
    canonical: `${SITE}/guides/bazi-month-pillar-solar-terms`,
  },
  {
