...
export const SEO_ARTICLE_LIST: SeoArticle[] = [
  ...
  {
    slug: 'bazi-month-pillar-solar-terms',
    path: '/guides/bazi-month-pillar-solar-terms',
    ...
    hero: {
      badge: '指南 · 排盘准度',
      title: '为什么同一天出生，月柱会不一样',
      subtitle:
        '很多人让 AI 排八字，得到的月柱是错的。原因通常不是“命理玄”，而是它按日历日切柱，没有按节气的精确时刻。下面是一组可以当场复核的对照。',
    },
    sections: [
      {
        heading: '月柱不跟日历走，跟节气时刻走',
        paragraphs: [
          '八字的月柱在「节」上切换（立春、惊蛰、清明等），不是在每月 1 号，也不是在节气当天的 0 点。年柱同样在立春的精确时刻切换，不是春节，也不是公历 1 月 1 日。',
          '只输入“1999 年 2 月 4 日”而忽略几点几分，节气边界附近的盘会整月、整年都错。通用大模型如果按日期表查，也容易在交节前后给出同一套月柱。',
        ],
      },
      {
        heading: '可复现对照：2024 年立春',
        paragraphs: [
          '2024 年立春交节时刻是北京时间 2024-02-04 16:27:07。同一天、前后不到两分钟，年柱和月柱都会换。山海灵境按这一时刻排盘。',
        ],
        bullets: [
          '16:26：年柱癸卯 · 月柱乙丑（仍是上一年、丑月）',
          '16:27:07：立春交节',
          '16:28：年柱甲辰 · 月柱丙寅（新年、寅月）',
          '如果你的工具在 16:26 就给出甲辰/丙寅，或在 16:28 仍给出癸卯/乙丑，它没有按节气时刻换柱。',
        ],
      },
      {
        heading: '第二组：同年惊蛰，只换月柱',
        paragraphs: [
          '2024 年惊蛰是北京时间 2024-03-05 10:22:45。这一次年柱不变，只换月柱，更能看出“按日切”和“按时刻切”的差别。',
        ],
        bullets: [
          '10:10：年柱甲辰 · 月柱丙寅',
          '10:30：年柱甲辰 · 月柱丁卯',
      ...
      {
        heading: '通用 AI 为什么会排错',
        paragraphs: [
          '大模型没有内置节气时刻表时，常见三种偷懒：按农历正月初一切年、按公历月初切月、或把“立春那一天”整日都算作新年。这三种都会在交节前后给出对任何时辰都一样的月柱。',
          '山海灵境用节气精确时刻排年月柱，日柱按真太阳时校正后的日期，时柱按校正后的时辰。这不是营销话术，是可以用上面两组时间当场对答案的。',
        ],
      },
      {
        heading: '你怎么自测',
        paragraphs: [
          '打开免费八字排盘，历法选公历，时区按北京时间，分别输入 2024-02-04 16:26 和 16:28。年柱、月柱应该不同。再拿你自己的生日，如果落在节气当天，务必补上出生时刻。',
          '时辰不详时，年月柱仍可看，时柱与日柱交界要降权。不要为了图省事随便填午时。',
        ],
      },
    ],
    faq: [
      {
        question: '节气换月是按出生地时间还是北京时间？',
        answer:
          '天文节气是绝对时刻。排盘时先把出生地民用时换成北京时间，再对照节气时刻。山海灵境会做这一步，并在有经度时再做真太阳时校正。',
      },
      {
        question: '这能证明排盘“绝对准”吗？',
        answer:
          '不能。它只证明年月柱有没有按节气时刻切换。解读仍是娱乐与自我反思，不是判决。',
      },
      {
        question: '和真太阳时是一回事吗？',
        answer:
          '不是。节气换柱决定年月柱；真太阳时校正主要影响时柱，跨过子时还会带动日柱。两件事都要做，漏一个都会在边界盘上出错。',
      },
    ],
    cta: { primary: '用节气时刻排一次', secondary: '查看全部指南' },
  },
  {
    slug: 'cezi-examples',
