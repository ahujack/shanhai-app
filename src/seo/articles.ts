...
export const SEO_ARTICLE_LIST: SeoArticle[] = [
  ...
  },
  {
    ...
    hero: {
      badge: '指南 · 八字日主',
      title: '八字日主怎么看：先抓住“我是谁”这一格',
      subtitle:
        '日主是八字解读的核心锚点。这篇用白话讲清：日主在哪里、十天干各像什么、强弱怎么理解、如何把它变成可执行的自我观察，而不是标签审判。',
    },
    sections: [
      {
        heading: '日主是什么？一句话定位',
        paragraphs: [
          '日主 = 出生日那天的天干。它象征“我”在这张符号地图里的位置：反应方式、压力来源、关系互动习惯，往往都从这里展开。',
          '看八字如果跳过日主，直接看大运流年，很容易变成碎片信息。建议永远先问：我的日主是什么？它当下偏强还是偏弱？',
        ],
      },
      {
        heading: '怎么在排盘结果里找到日主',
        paragraphs: ['按这个顺序找，30 秒就能定位：'],
        bullets: [
          '先找到日柱（四柱里的“日”）。',
          '日柱上方/左侧的天干，就是日主。',
          '记下日主对应五行：甲乙木、丙丁火、戊己土、庚辛金、壬癸水。',
          '再看周围字对它是生、克、耗、还是帮扶，形成强弱感觉。',
        ],
      },
      {
        heading: '十天干白话速查（入门版）',
        paragraphs: [
          '下面不是性格定论，而是常见倾向。请结合现实经历对照，不要对号入座到极端：',
        ],
        bullets: [
          '甲木：像大树，要方向与成长空间；卡住时常因不愿弯曲。',
          '乙木：像藤蔓，柔韧善借力；要注意边界被过度迁就。',
          '丙火：像太阳，表达欲强、带动气氛；需防透支与急躁。',
          '丁火：像灯火，细腻专注；压力大时容易内耗。',
          '戊土：像高山，稳重担当；转变慢，但一旦决定很坚定。',
          '己土：像田土，包容协调；要防边界不清、过度照顾他人。',
          '庚金：像刀剑，果断直接；冲突时需学会收力。',
          '辛金：像珠玉，讲究质感与分寸；易因完美而拖延。',
          '壬水：像江河，想法活、流动快；需防目标飘移。',
          '癸水：像雨露，敏感洞察；要避免情绪淹没行动。',
        ],
      },
      {
        heading: '日主强弱：先看“够不够用”，别先看吉凶',
        paragraphs: [
          '入门阶段，把强弱理解成“能量是否够支撑当前选择”更实用：',
        ],
        bullets: [
          '偏强：行动力足，但容易硬推；适合练“减速、听取、留余地”。',
          '偏弱：敏感细腻，但易被环境影响；适合练“边界、节奏、小步验证”。',
          '中和：不是最强也不是最弱；关键看当下场景缺的是冲劲还是稳定。',
        ],
      },
      {
        heading: '把日主变成 7 天行动（高转化用法）',
        paragraphs: [
          '不要停在“我是甲木所以怎样”。把它落成一周实验：',
        ],
        bullets: [
          '写出日主一句话：我做事时默认像……',
          '写出一个副作用：这让我在……场景容易吃亏。',
          '选一个最小纠正动作：本周只改一件事（例如会议先听完再提方案）。',
          '周末复盘：这个动作让关系/效率变好了吗？',
        ],
      },
      {
        heading: '常见误区',
        paragraphs: ['这几条会显著降低解读质量：'],
        bullets: [
          '只用日主贴标签，忽略月令与整体组合。',
          '把“喜用神”当成必须服从的命令。',
          '时辰不准却强行解读日主细节到人生定论。',
          '用日主证明“我注定失败/成功”，放弃现实努力。',
        ],
      },
    ],
    faq: [
      {
        question: '日主和生肖是一回事吗？',
        answer:
          '不是。生肖多按年支理解；日主是日柱天干，侧重点完全不同。',
      },
      {
        question: '日主看懂了还要看别的吗？',
        answer:
          '要。日主是起点，接着再看五行平衡、关系线索与阶段性节奏，信息才会立体。',
      },
      {
        question: '可以只靠日主做重大决定吗？',
        answer:
          '不可以。日主适合自我观察与沟通风格调整；重大决策仍需现实条件与专业意见。',
      },
    ],
    cta: { primary: '排盘查看我的日主', secondary: '查看全部指南' },
  },
  {
    slug: 'cezi-character-pitfalls',
    path: '/guides/cezi-character-pitfalls',
    ...
    hero: {
      badge: '指南 · 测字避坑',
      title: '测字选字避坑清单：选错字，再准的解读也漂',
      subtitle:
        '很多人觉得“测字不准”，问题常出在选字。这篇给你一份可勾选的避坑清单：先排除无效字，再进入高信号选字流程。',
    },
    sections: [
      {
        heading: '先说结论：好字要满足 3 个条件',
        paragraphs: ['开始避坑前，记住合格选字标准：'],
        bullets: [
          '有连接：看到它会心里一紧或一动，不是随机抓取。',
          '有场景：能对应你正在纠结的那个具体问题。',
          '有余地：不是只想听到某个答案而故意挑的字。',
        ],
      },
      {
        heading: '避坑 1：别选“万能吉利字”当安慰剂',
        paragraphs: [
          '如：顺、旺、发、赢、爱（在你只是想听好话时）。这类字容易变成情绪安抚，而不是问题澄清。',
          '替换方法：改选与动作相关的字，如“谈、等、走、定、守”。',
        ],
      },
      {
        heading: '避坑 2：别选与问题无关的生僻字显摆',
        paragraphs: [
          '生僻字不是更灵，只是更难建立身心连接。若你对字义完全无感，解读会变成空转。',
          '替换方法：优先选你会写、会用、当下第一个冒出来的常用字。',
        ],
      },
      {
        heading: '避坑 3：别把人名/昵称硬测成命运判决',
        paragraphs: [
          '测对方名字可以作参考，但别把它当成“他爱不爱我”的最终证据。名字信息密度高、干扰也多。',
          '替换方法：改测关系动作字，如“复、分、信、依、远”。',
        ],
      },
      {
        heading: '避坑 4：别在情绪顶峰连续换字刷结果',
        paragraphs: [
          '刚吵完架或刚被拒时，连续换字很容易“抽到想听的”。这不是校准，是自我说服。',
          '替换方法：先冷静 20 分钟，只保留第一次有连接感的字，并写清问题后再测。',
        ],
      },
      {
        heading: '避坑 5：别一次塞进多个问题',
        paragraphs: [
          '一个字同时问感情、赚钱、搬家，结果会糊。测字的优势是“一字一事”。',
          '替换方法：拆成两次：先测“本月是否适合提离职”，再测“感情是否适合深聊”。',
        ],
      },
      {
        heading: '30 秒选字自检表（测前勾选）',
        paragraphs: ['全部勾上再开始，命中率会稳定很多：'],
        bullets: [
          '我已经用一句话说清问题（含时间框）。',
          '这个字是我第一反应，不是搜出来的“好运字”。',
          '我能接受不好听的提醒。',
          '我准备好把结果落成一个可验证的小行动。',
        ],
      },
      {
        heading: '推荐选字流程（可直接照做）',
        paragraphs: [
          '1）写下问题 → 2）闭眼 10 秒，写出第一个字 → 3）检查是否踩坑 → 4）选择聚焦标签（感情/事业等）→ 5）解读后只执行一个最小行动。',
          '在山海灵境里，你可以用手写增强仪式感；但打字也完全有效，关键仍是选字质量。',
        ],
      },
    ],
    faq: [
      {
        question: '选错字了可以重测吗？',
        answer:
          '可以，但先复盘错在哪里（想听好话、问题太宽、情绪过冲），再重测；不要无间隔连刷。',
      },
      {
        question: '必须用手写才准吗？',
        answer:
          '不是必须。手写增加笔势信息与专注度；连接感和问题清晰度通常更关键。',
      },
      {
        question: '避坑后仍然觉得不准怎么办？',
        answer:
          '把“准”改成“有没有推动一个可验证行动”。若连续两次都无法转化为行动，先停测，改用现实清单决策。',
      },
    ],
    cta: { primary: '避开坑后再测一字', secondary: '查看全部指南' },
  },
];
